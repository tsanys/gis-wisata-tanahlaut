            ...
            <div class="form-body">
              <div class="row">
                ...
                <div class="col-md-8 form-group">
                  <input type="text" value="<?= $wisata->nama_wisata ?>" required class="form-control"
                ...
                <div class="col-md-8 form-group">
                  <input type="text" value="<?= $wisata->deskripsi ?>" required class="form-control" name="deskripsi"
                ...
                <div class="col-md-8 form-group">
                  <input type="text" value="<?= $wisata->alamat ?>" required class="form-control" name="alamat"
                    placeholder="Alamat">
                </div>
                ...
                <div class="col-md-8 form-group">
                  <input type="text" value="<?= $wisata->kategori ?>" required class="form-control" name="kategori"
                ...
                <div class="col-md-8 form-group d-flex align-items-center">
                  ...
                  <input type="text w-80" id="Latitude" value="<?= $wisata->latitude ?>" class="form-control"
                ...
                <div class="col-md-8 form-group d-flex align-items-center">
                  ...
                  <input type="text w-80 " id="Longitude" value="<?= $wisata->longitude ?>" class="form-control"
                ...
                <div class="col-md-8 form-group d-flex align-items-center">
                  <img src="<?= base_url('gambar/'. $wisata->gambar) ?>" class="rounded" width="100%">
                </div>
                <div class="col-md-4">
